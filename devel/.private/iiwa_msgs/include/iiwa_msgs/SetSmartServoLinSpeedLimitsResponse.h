...
bool operator==(const ::iiwa_msgs::SetSmartServoLinSpeedLimitsResponse_<ContainerAllocator1> & lhs, const ::iiwa_msgs::SetSmartServoLinSpeedLimitsResponse_<ContainerAllocator2> & rhs)
{
