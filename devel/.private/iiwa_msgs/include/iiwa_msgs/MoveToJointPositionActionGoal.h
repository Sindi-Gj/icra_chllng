...
bool operator==(const ::iiwa_msgs::MoveToJointPositionActionGoal_<ContainerAllocator1> & lhs, const ::iiwa_msgs::MoveToJointPositionActionGoal_<ContainerAllocator2> & rhs)
{
