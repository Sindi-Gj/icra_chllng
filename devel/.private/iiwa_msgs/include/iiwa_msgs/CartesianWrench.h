...
bool operator==(const ::iiwa_msgs::CartesianWrench_<ContainerAllocator1> & lhs, const ::iiwa_msgs::CartesianWrench_<ContainerAllocator2> & rhs)
{
  return lhs.header == rhs.header &&
    lhs.wrench == rhs.wrench &&
    lhs.inaccuracy == rhs.inaccuracy;
}
